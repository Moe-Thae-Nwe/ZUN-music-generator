const name = [//Touhou Reiiden ~ Highly Responsive to Prayers
  "A Sacred Lot / A Sacret Lot", "Eternal Shrine Maiden", "Yin-Yang ~ The Positive and Negative / The Positive and Negative", "A Soul Devoted to the Gods ~ Highly Responsive to Prayers / Highly Responsive / Highly Responsive to Prayers", "Eastern Tale of Fancy", "Angel's Legend", "Oriental Magician", "Blade of Banishment", "Magic Mirror", "The Legend of KAGE", "Now, Until the Moment You Die", "Theme of Turning to Hell / We Shall Die Together / Civilization of Magic", 'Angel of a Distant Star ~ The "★Alice-in-Wonderland" Angel / Swordsman of a Distant Star / Angel of a Distant Star', "Iris", "Shrine of the Wind",
  //Touhou Fuumaroku ~ Story of Eastern Wonderland
  "Eastern Demon-Sealing Record ~ Pure Land Mandala", "Hakurei ~ Eastern Wind", "She's in a temper!!", "End of Daylight", "Power of Darkness", "World of Fantasies", "Bet on Death", "Himorogi, Burn in Violet", "Love-Coloured Magic / Love-Coloured Master Spark", "Eastern Demon-Sealing Record ~ Spectral Boisterous Dance", "Complete Darkness", "Crazy Magic / Extra Love", "The Tank Girl's Dream", "Forest of Tono", "Crossing the Blue Sky / Legendary Wonderland", "Hakurei Shrine Grounds", "Sunfall", "Demon-Sealing Finale", 
  ...
  "Gensoukyou ~ Lotus Land Story", "Witching Dream", "Selene's Light", "Decoration Battle ~ Decoration Battle", "Break the Sabbath", "Scarlet Symphony ~ Scarlet Phoneme", "Bad Apple!!", "Spirit Battle ~ Perdition Crisis", "Alice Maestra", "Maiden's Cappricio ~ Cappricio / Maiden't Cappricio ~ Dream Battle", "Vessel of Stars ~ Casket of Star", "Lotus Love", "Sleeping Terror ~ Sleeping Terror", "Dream Land", "Faint Dream ~ Inanimate Dream", "The Inevitably Forbidden Game", "Illusion of a Maid ~ Icemilk Magic", "Cute Devil ~ Innocence", "Days", "Peaceful", "Arcadian Dream", "Those Who Live in Illusions", "Lotus Road", "Dreamy Pilot", "Incomplete Plot", "Border Land", "Magic Shop of Raspberry", "Crescent Dream", 
